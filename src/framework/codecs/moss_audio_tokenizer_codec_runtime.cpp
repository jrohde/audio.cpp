...
inline TransformerWeights load_transformer(
    ...
    // leaves out whichever would be an identity, which is the output projection on three of
    // four decoder stages and the input projection on three of four encoder stages.
